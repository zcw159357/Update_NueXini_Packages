...
echo 'NueXini 规则,NueXini_basic.ini,https://raw.githubusercontent.com/NueXini/Proxy-Rules/master/Clash/NueXini_basic.ini' >> ./luci-app-openclash/root/usr/share/openclash/res/sub_ini.list
rm -rf .svn
####################################################################################################
